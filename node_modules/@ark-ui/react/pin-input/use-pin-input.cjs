...
const usePinInput = (props) => {
  ...
  const [state, send] = react.useMachine(pinInput__namespace.machine(initialContext), { context });
  return pinInput__namespace.connect(state, send, react.normalizeProps);
};
