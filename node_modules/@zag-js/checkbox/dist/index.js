...
var anatomy = (0, import_anatomy.createAnatomy)("checkbox").parts("root", "input", "label", "control");
...
var dom = (0, import_dom_query.createScope)({
  ...
  getInputId: (ctx) => ctx.ids?.input ?? `checkbox:${ctx.id}:input`,
    ...
    },
    {
      activities: {
        trackFormControlState(ctx2, _evt, { send, initialContext }) {
          return (0, import_form_utils.trackFormControl)(dom.getInputEl(ctx2), {
            onFieldsetDisabled() {
              ctx2.disabled = true;
            },
            onFormReset() {
      ...
      actions: {
        ...
        dispatchCheckedEvent(ctx2, evt) {
          ...
          (0, import_form_utils.dispatchInputCheckedEvent)(inputEl, { checked, bubbles: true });
        },
