    ...
    },
    {
      ...
      activities: {
        syncInputValue: (ctx2) => {
          ...
          if (!inputEl)
            return;
          return (0, import_mutation_observer.observeAttributes)(inputEl, ["data-value"], () => {
        ...
        scrollOptionIntoView(ctx2, _evt, { getState }) {
          const inputEl = dom.getInputEl(ctx2);
          return (0, import_mutation_observer.observeAttributes)(inputEl, ["aria-activedescendant"], () => {
