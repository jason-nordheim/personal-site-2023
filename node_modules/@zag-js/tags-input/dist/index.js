...
var dom = (0, import_dom_query.createScope)({
  ...
  getElements: (ctx) => (0, import_dom_query.queryAll)(dom.getRootEl(ctx), `[data-part=tag]:not([data-disabled])`),
  getFirstEl: (ctx) => dom.getElements(ctx)[0],
  getLastEl: (ctx) => dom.getElements(ctx)[dom.getElements(ctx).length - 1],
  getPrevEl: (ctx, id) => (0, import_dom_query.prevById)(dom.getElements(ctx), id, false),
  getNextEl: (ctx, id) => (0, import_dom_query.nextById)(dom.getElements(ctx), id, false),
  getElAtIndex: (ctx, index) => dom.getElements(ctx)[index],
  getIndexOfId: (ctx, id) => (0, import_dom_query.indexOfId)(dom.getElements(ctx), id),
