      ...
      actions: {
        ...
        setValueText(ctx2) {
          if (!ctx2.value.length)
            return;
          ctx2.valueText = ctx2.value.map((date) => (0, import_date_utils2.formatSelectedDate)(date, null, ctx2.locale, ctx2.timeZone)).join(", ");
        },
        ...
        setFocusedDate(ctx2, evt) {
          ...
          ctx2.focusedValue = (0, import_date_utils2.constrainValue)(value, ctx2.min, ctx2.max);
        },
        ...
        setPreviousDate(ctx2) {
          ctx2.focusedValue = (0, import_date_utils2.getPreviousDay)(ctx2.focusedValue);
        },
        setNextDate(ctx2) {
          ctx2.focusedValue = (0, import_date_utils2.getNextDay)(ctx2.focusedValue);
        },
        ...
        clearFocusedDate(ctx2) {
          ctx2.focusedValue = (0, import_date_utils2.getTodayDate)(ctx2.timeZone);
        },
