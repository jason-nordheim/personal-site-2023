import { RawCondition, Dict, UtilityConfig, PropertyConfig, PatternHelpers, RecipeConfig, SlotRecipeConfig, CssKeyframes, StaticCssOptions, SystemStyleObject } from '@pandacss/types';
...
declare class Recipes {
    ...
    constructor(recipes?: RecipeRecord, context?: StylesheetContext | undefined);
    private getPropKey;
    ...
    getConfig: (name: string) => RecipeConfig | SlotRecipeConfig;
    ...
    normalize: (name: string, config: RecipeConfig) => Required<RecipeConfig>;
    private serialize;
...
export { AtomicRule, Breakpoints, Conditions, Recipes, Stylesheet, StylesheetContext, StylesheetOptions, Utility, assignCompositions, discardDuplicate, expandCssFunctions, expandNestedCss, extractParentSelectors, getStaticCss, isSlotRecipe, mergeCss, optimizeCss, prettifyCss, sharedHooks, toCss, toKeyframeCss };
