...
var Recipes = class {
  ...
  save = () => {
    for (const [name, recipe] of Object.entries(this.recipes)) {
      if (isSlotRecipe(recipe)) {
        const slots = (0, import_shared9.getSlotRecipes)(recipe);
  ...
  assignRecipe = (name, recipe) => {
    ...
    const match3 = (0, import_shared9.createRegex)(jsx);
...
var Utility = class {
  ...
  getPropertyValues = (config, resolveFn) => {
    ...
    if ((0, import_shared11.isString)(values)) {
    ...
    if ((0, import_shared11.isFunction)(values)) {
  ...
  defaultTransform = (0, import_shared11.memo)((value, prop) => {
  ...
  setClassName = (property, raw) => {
    ...
    if (!config || !config.className) {
      className = this.hash((0, import_shared11.hypenateProperty)(property), raw);
    } else {
  ...
  transform = (prop, value) => {
    ...
    return (0, import_shared11.compact)({
      layer: this.configs.get(key)?.layer,
      className: this.getOrCreateClassName(key, (0, import_shared11.withoutSpace)(value)),
